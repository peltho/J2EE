...
public class ConsultationTestClient {
	...
	public ConsultationTestClient() {
		...
		try{
			...
			service="ejb:coreMear/gestioncabinet-coreM//PlanningService!miage.gestioncabinet.api.PlanningRemoteService?stateful";
			...
			service="ejb:coreMear/gestioncabinet-coreM//ConsultationService!miage.gestioncabinet.api.ConsultationRemoteService?stateful";
